...
\author[1,2,3*]{R Cameron Craddock}\cor{}\email{ccraddock@nki.rfmh.org}
\author[1,4]{Daniel S Margulies}\email{margulies@cbs.mpg.de}
\author[1,5,6]{Pierre Bellec}\email{pierre.bellec@criugm.qc.ca}
\author[1,7,8]{B Nolan Nichols}\email{nolan.nichols@gmail.com}
\author[9]{Sarael Alcauter}\email{alcauter@gmail.com}
\author[9]{Fernando A Barrios}\email{fbarrios@unam.mx}
\author[10,11]{Yves Burnod}\email{yburnod@gmail.com}
\author[12]{Christopher J Cannistraci}\email{Christopher.Cannistraci@mssm.edu}
\author[6,13]{Julien Cohen-Adad}\email{jcohen@polymtl.ca}
\author[13]{Benjamin De Leener}\email{benjamin.de-leener@polymtl.ca}
...
\author[1,18,19,20]{Alexandre R Franco}\email{alexandre.franco@pucrs.br}
\author[1,2]{Caroline Seligman Froehlich}\email{cfroehlich@nki.rfmh.org}
\author[21,22]{Andrew J Gerber}\email{GerberA@nyspi.columbia.edu}
\author[1,23,24]{Satrajit S Ghosh}\email{satra@mit.edu}
\author[25,26]{Thomas J Grabowski}\email{tgrabow@uw.edu}
\author[27,28]{Sean Hill}\email{sean.hill@incf.org}
\author[29]{Anibal S\'{o}lon Heinsfeld}\email{anibal.heinsfeld@acad.pucrs.br}
\author[1,30]{R Matthew Hutchison}\email{rhutchison@fas.harvard.edu}
\author[1,12]{Prantik Kundu}\email{prantik.kundu@mssm.edu}
\author[31]{Angela R Laird}\email{alaird@fiu.edu}
\author[1,32,33]{Sook-Lei Liew}\email{sliew@usc.edu}
\author[34]{Daniel J Lurie}\email{danjlurie@gmail.com}
\author[1,35,36]{Donald G McLaren}\email{donald@biospective.com}
\author[29]{Felipe Meneguzzi}\email{felipe.meneguzzi@pucrs.br}
\author[1,37]{Maarten Mennes}\email{mennes.maarten@gmail.com}
\author[11,38]{Salma Mesmoudi}\email{salma.mesmoudi@gmail.com}
\author[3]{David O'Connor}\email{david.oconnor@childmind.org}
\author[9]{Erick H Pasaye}\email{pasayeric@hotmail.com}
\author[39]{Scott Peltier}\email{spelt@umich.edu}
\author[40,41]{Jean-Baptiste Poline}\email{jbpoline@gmail.com}
\author[42]{Gautam Prasad}\email{gautam.prasad@loni.usc.edu}
\author[29]{Ramon Fraga Pereira}\email{ramon.pereira@acad.pucrs.br}
\author[6]{Pierre-Olivier Quirion}\email{pioliqui@gmail.com}
\author[43]{Ariel Rokem}\email{arokem@gmail.com}
\author[44]{Ziad S Saad}\email{ziad.ss@gmail.com}
\author[42]{Yonggang Shi}\email{yonggang.shi@loni.usc.edu}
\author[17,45,46]{Stephen C Strother}\email{sstrother@research.baycrest.org}
\author[1,47,48]{Roberto Toro}\email{rto@pasteur.fr}
\author[1,49,50]{Lucina Q Uddin}\email{l.uddin@miami.edu}
\author[33]{John D Van Horn}\email{jvanhorn@usc.edu}
\author[51]{John W Van Meter}\email{john.vanmeter.phd@gmail.com}
\author[52,53]{Robert C Welsh}\email{rcwelsh@umich.edu}
\author[3]{Ting Xu}\email{ting.xu@childmind.org}
